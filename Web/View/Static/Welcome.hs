...
instance View WelcomeView where
    html WelcomeView = [hsx|
         <div style="background-color: #6b3a9dff; padding: 2rem; color:hsla(196, 13%, 96%, 1); border-radius: 4px">
              <div style="max-width: 800px; margin-left: auto; margin-right: auto">
                  ...
                  <p>
                      <a
                          ...
                          style="margin-top: 2rem; background-color: #ffffffff; padding: 1rem; border-radius: 3px; color: hsla(210, 6%, 6%, 1.00); text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px hsla(205, 69%, 0%, 0.08); transition: box-shadow 0.2s; transition: transform 0.2s;"
                          target="_blank"
                      >Join our community on Slack!</a>
                  </p>

                  <a href="https://ihp.digitallyinduced.com/Guide/your-first-project.html" style="margin-top: 2rem; background-color: #ffffffff; padding: 1rem; border-radius: 3px; color: hsla(206, 58%, 5%, 1.00); text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px hsla(205, 69%, 0%, 0.08);  transition: box-shadow 0.2s; transition: transform 0.2s;" target="_blank">
         ...
         <div style="max-width: 800px; margin-left: auto; margin-right: auto; margin-top: 4rem">
              ...
              <p style="color: hsla(304, 13%, 50%, 1.00); margin-top: 4rem">
